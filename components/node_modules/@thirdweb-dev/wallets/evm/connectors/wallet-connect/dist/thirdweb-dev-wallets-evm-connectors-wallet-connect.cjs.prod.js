  ...
  async connect() {
    ...
    try {
      ...
      if (!provider.session || isChainsStale) {
        ...
        const optionalChains = (this.chains.length > 50 ? [1, 5, 84531, 137, 80001, 42161, 421613, 10, 420, 56, 97, 250, 4002, 43114, 43113, 1337] : this.chains.map(_ref => {
          let {
            chainId
          } = _ref;
          return chainId;
        ...
        await classPrivateMethodGet._classPrivateMethodGet(this, _setRequestedChainsIds, _setRequestedChainsIds2).call(this, this.chains.map(_ref2 => {
          let {
            chainId
          } = _ref2;
          return chainId;
...
async function _initProvider2() {
  ...
  const [defaultChain, ...optionalChains] = this.chains.map(_ref3 => {
    let {
      chainId
    } = _ref3;
    return chainId;
...
async function _isChainsStale2() {
  ...
  const requestedChains = await classPrivateMethodGet._classPrivateMethodGet(this, _getRequestedChainsIds, _getRequestedChainsIds2).call(this);
  const connectorChains = this.chains.map(_ref4 => {
    let {
      chainId
    } = _ref4;
    return chainId;
