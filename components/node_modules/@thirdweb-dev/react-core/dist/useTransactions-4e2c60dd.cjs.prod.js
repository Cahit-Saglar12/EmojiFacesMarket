...
function useSmartWallets(contract) {
  ...
  return useQueryWithNetwork(cacheKeys.contract.smartWalletFactory.getAll(contractAddress), () => {
    requiredParam.requiredParamInvariant(contract, "No Contract instance provided");
    invariant__default["default"](contract.smartWalletFactory.getAllAccounts, "Contract instance does not support contract.smartWalletFactory.getAllAccounts");
...
function useSmartWalletSigners(contract) {
  ...
  return useQueryWithNetwork(cacheKeys.contract.smartWallet.signers(contractAddress), () => {
    requiredParam.requiredParamInvariant(contract, "No Contract instance provided");
    invariant__default["default"](contract.smartWallet.getSignersWithRestrictions, "Contract instance does not support contract.smartWallet.getSignersWithRestrictions");
